...
$.holdReady(!0), $("body").imagesLoaded({
    background: ".background-holder"
}, function () {
    $("#preloader").removeClass("loading"), $.holdReady(!1), setTimeout(function () {
        $("#preloader").remove()
    }, 800)
...
$(document).ready(function () {
    var e = !!window.opr && !!opr.addons || !!window.opera || navigator.userAgent.indexOf(" OPR/") >= 0,
        ...
        r = (n || e) && !!window.CSS;
    e && $("html").addClass("opera"), i && $("html").addClass("firefox"), o && $("html").addClass("safari"), a && $("html").addClass("ie"), t && $("html").addClass("edge"), n && $("html").addClass("chrome"), r && $("html").addClass("blink")
}), $(document).ready(function () {
    is_EDGE || Modernizr.touchevents || is_mobile_ie || is_OSX || smoothScroll()
});